...
Definition InputModel : Model TTMetamodel_EObject TTMetamodel_ELink :=
	(Build_Model
		...
		(Build_TTMetamodel_EObject CellEClass (BuildCell (BuildLocatedElement "1260134048_LocatedElement" "") "1260134048_Cell" false)) :: 
		...
		(Build_TTMetamodel_ELink CellOwnerEReference (BuildCellOwner (BuildCell (BuildLocatedElement "1791868405_LocatedElement" "") "1791868405_Cell" true) (BuildRow (BuildLocatedElement "366004251_LocatedElement" "") "366004251_Row" ))) ::
		(Build_TTMetamodel_ELink CellPortEReference (BuildCellPort (BuildCell (BuildLocatedElement "1791868405_LocatedElement" "") "1791868405_Cell" true) (BuildPort (BuildLocatedElement "1454031203_LocatedElement" "") "1454031203_Port" "a"))) ::

		(Build_TTMetamodel_ELink CellOwnerEReference (BuildCellOwner (BuildCell (BuildLocatedElement "1260134048_LocatedElement" "") "1260134048_Cell" false) (BuildRow (BuildLocatedElement "366004251_LocatedElement" "") "366004251_Row" ))) ::
		(Build_TTMetamodel_ELink CellPortEReference (BuildCellPort (BuildCell (BuildLocatedElement "1260134048_LocatedElement" "") "1260134048_Cell" false) (BuildPort (BuildLocatedElement "527446182_LocatedElement" "") "527446182_Port" "b"))) ::
		...
		(Build_TTMetamodel_ELink RowCellsEReference (BuildRowCells (BuildRow (BuildLocatedElement "366004251_LocatedElement" "") "366004251_Row" ) ((BuildCell (BuildLocatedElement "1791868405_LocatedElement" "") "1791868405_Cell" true) :: (BuildCell (BuildLocatedElement "1260134048_LocatedElement" "") "1260134048_Cell" false) :: (BuildCell (BuildLocatedElement "391618063_LocatedElement" "") "391618063_Cell" true) :: nil ))) ::
